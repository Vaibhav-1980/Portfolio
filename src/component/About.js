...
const About = () => {
    return (
        ...
        <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <img src='./images/photo1.jpg' alt="Vaibhav Singh" className="rounded-lg shadow-lg mx-auto" />
        </div>
        <div className='w-full md:w-2/3 md:ml-8 mt-4 md:mt-0'>
            ...
            <div className='mt-10 md:mt-20'>
                <span>
                    I recently graduated with a degree in ETE from Ramaiah institute of tech. My portfolio includes full-stack projects like a Hospital Management System 
                    my proficiency in HTML,CSS,JS. I have a deep passion for web development and have honed my skills
