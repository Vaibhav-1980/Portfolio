  ...
  return (
    <div className="w-auto p-4">
      <div className="avatar mx-auto mb-4">
        <img src="https://res.cloudinary.com/bsingh6636/image/upload/v1723648948/myPhoto/pp_photo_Vaibhav_vcop2n.jpg" alt="Vaibhav" />
      </div>
      <div className="content text-center">
        <h1 className="text-xl font-bold">Vaibhav Kumar Kushwaha</h1>
        <p>Follow me on:</p>
        <p className="flex justify-center space-x-4">
          ...
          <span><a href="https://x.com/Vaibhav6636" target="_blank" rel="noreferrer"><i className="fa fa-twitter"></i></a></span>
